...
namespace ATM.Core
{
    ...
    {
        static public MessageModel Cash(int desireSumm, int desireBancnote, ObservableCollection<MoneyCassetteModel> moneyCassette)
        {
        ...
        static private MoneyCassetteModel GetMatchingCassette(int balance, MoneyCassetteModel cassette, ObservableCollection<MoneyCassetteModel> moneyCassette)
        {
            for (int i = moneyCassette.Count - 1; i >= 0; i--)
            {
